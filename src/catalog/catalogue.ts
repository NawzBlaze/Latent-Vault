...
export const CATALOGUE: ContentItem[] = [
  item({
    ...
    thumbnail: '/posters/s2-e1.svg',
    heroImage: '/posters/s2-e1-hero.svg',
  ...
  item({
    ...
    archivedAt: null,
    durationSeconds: null,
    thumbnail: '/posters/s2-e2.svg',
    heroImage: '/posters/s2-e2-hero.svg',
  ...
  item({
    ...
    thumbnail: '/posters/s2-e3.svg',
    heroImage: '/posters/s2-e3-hero.svg',
  ...
  item({
    ...
    thumbnail: '/posters/s2-e4.svg',
    heroImage: '/posters/s2-e4-hero.svg',
  ...
  item({
    ...
    thumbnail: '/posters/s2-e5.svg',
    heroImage: '/posters/s2-e5-hero.svg',
  ...
  item({
    ...
    thumbnail: '/posters/s2-e6.svg',
    heroImage: '/posters/s2-e6-hero.svg',
  ...
  item({
    ...
    thumbnail: '/posters/s2-bonus-e1.svg',
    heroImage: '/posters/s2-bonus-e1-hero.svg',
  ...
  item({
    ...
    thumbnail: '/posters/s2-bonus-e2.svg',
    heroImage: '/posters/s2-bonus-e2-hero.svg',
  ...
  item({
    ...
    thumbnail: '/posters/s2-bonus-e3.svg',
    heroImage: '/posters/s2-bonus-e3-hero.svg',
